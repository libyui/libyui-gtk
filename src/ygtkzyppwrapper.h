...
struct YGtkZyppModel
{
	...
	enum Columns {
		ICON_COLUMN, NAME_COLUMN, SUMMARY_COLUMN, NAME_SUMMARY_COLUMN,
		REPOSITORY_COLUMN, SUPPORT_COLUMN, INSTALLED_VERSION_COLUMN, AVAILABLE_VERSION_COLUMN,
		TO_INSTALL_COLUMN, TO_UPGRADE_COLUMN, NOT_TO_REMOVE_COLUMN, TO_MODIFY_COLUMN,
		IS_UNLOCKED_COLUMN, IS_HIGHLIGHT_WEIGHT_COLUMN, IS_MODIFIED_ITALIC_COLUMN,
		PTR_COLUMN, TOTAL_COLUMNS
	};

	Ypp::PkgList *list;

	struct PkgListNotify;
	PkgListNotify *notify;
};
